...
Get started by reading the [guidelines to develop client libraries](./library-guidelines.md), which have been written to ensure the client libraries provide a consistent feel and behavior across programming languages. You certainly need to understand the [glossary](../../glossary.md) and the concepts behind [processes](../api/reference.md#section/Processes) and [process graphs](../api/reference.md#tag/Process-Graphs). This helps you understand the [API specification](../api/reference.md) and related documents.
